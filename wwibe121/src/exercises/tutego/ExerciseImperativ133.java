 ...
 * @version 1.0
 */
public class ExerciseImperativ133 {
	...
	public static void main(String[] args) {
		...
		} else if (digit1Number1 == digit1Number2 || digit1Number1 == digit2Number2 || digit2Number1 == digit1Number2
				|| digit2Number1 == digit2Number2) {
