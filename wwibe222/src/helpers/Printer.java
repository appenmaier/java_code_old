...
public class Printer {
  ...
  /**
   * Gibt eine Linie bestehend aus einem eingehenen Zeichen auf der Konsole aus. Die Linie ist von
   * einem eingehenden Prefix und einem eingehenden Suffix umschlossen
   * 
   * @param prefix Prefix
   * @param length Laenge der Linie
   * @param c Zeichen
