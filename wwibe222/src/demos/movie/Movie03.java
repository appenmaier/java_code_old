...
public class Movie03 {
	...
	public Movie03(String title, ArrayList<Genre02> genres, String year, int runtimeInMinutes, double rating,
			int votes) {
		super();
		this.title = title;
		this.genres = genres;
	...
	public String toString() {
		return "Movie02 [title=" + title + ", genres=" + genres + ", year=" + year + ", runtimeInMinutes="
