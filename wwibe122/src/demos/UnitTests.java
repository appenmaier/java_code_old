...
public class UnitTests {
  ...
  // } catch (Exception e) {
  // System.err.println("Testfall 1 fehlgeschlagen");
  // }
  //
  // try {
  // test.testGetBmi();
  ...
  // } catch (Exception e) {
  // System.err.println("Testfall 2 fehlgeschlagen");
  // }
  //
  // try {
  // test.testGetBmiCategory();
  // System.out.println("Testfall 3 erfolgreich");
  // } catch (Exception e) {
  // System.err.println("Testfall 3 fehlgeschlagen");
  // }
  //
  // }
