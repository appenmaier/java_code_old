...
public class Radio_v8 {
  ...
  public Radio_v8(double frequency) {
    this.frequency = frequency;
  }

  public Radio_v8(String sender) {
    frequency = Radio_v8.senderToFrequency(sender);
  }

  public Radio_v8(Radio_v8 r) {
    isOn = r.isOn();
    volume = r.getVolume();
