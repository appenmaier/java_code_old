 ...
 * 
 */
public class Radio_v10 extends ElectronicDevice {
  ...
  public Radio_v10(double frequency) {
    this.frequency = frequency;
  }

  public Radio_v10(String sender) {
    frequency = Radio_v10.senderToFrequency(sender);
  }

  public Radio_v10(Radio_v10 r) {
    if (r.isOn()) {
      on();
    }
    volume = r.getVolume();
