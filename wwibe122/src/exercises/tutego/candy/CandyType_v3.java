...
public enum CandyType_v3 {
  ...
  private CandyType_v3(int addictiveQuality) {
    this.addictiveQuality = addictiveQuality;
  }

  public static CandyType_v3 random() {
    CandyType_v3[] values = CandyType_v3.values();
    int index = (int) (Math.random() * values.length);
    return values[index];
  }

  public static CandyType_v3 fromName(String name) {
    String value;
    value = name.toUpperCase();
    value = value.replace(" ", "_");
    for (CandyType_v3 c : CandyType_v3.values()) {
