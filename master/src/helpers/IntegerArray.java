...
public class IntegerArray {
	...
	/**
	 * Durchsucht ein Zahlenfeld nach einem eingehenden Wert und gibt, fuer den
	 * Fall, dass der Wert gefundenden wurde, den Index des eingehenden Wertes
	 * zurueck. Sollte der eingehende Wert nicht gefunden werden, wir -1
	 * zurueckgegeben
	 * 
	 * @param array Zahlenfeld
	 * @param value Wert
